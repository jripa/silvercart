...
class SubNavigationWidget extends Widget {
    ...
    public function NavigationCacheKey()
    {
        ...
        $lastEditedPageMaxPage = '';

        if ($lastEditedPage) {
            $key .= '_' . $lastEditedPage->LastEdited;
            $lastEditedPageMaxPage =  $lastEditedPage->LastEdited; 
        }
   
        $currentPage = Controller::curr();

        if ($currentPage && $lastEditedPageMaxPage) {
            ...
            $cacheKeyParts = [
                ...
                $lastEditedPage->LastEdited,
            ];

            //$this->extend('updateNavigationCacheKeyParts', $cacheKeyParts);
