...
jQuery.fn.daterangepicker = function(settings){
    ...
    var options = jQuery.extend({
        presetRanges: [
            {text: 'Heute', dateStart: 'today', dateEnd: 'today' },
            {text: 'Letzte 7 Tage', dateStart: 'today-7days', dateEnd: 'today' },
            {text: 'Dieser Monat', dateStart: function(){ return Date.parse('today').moveToFirstDayOfMonth();  }, dateEnd: 'today' },
            {text: 'Dieses Jahr', dateStart: function(){ var x= Date.parse('today'); x.setMonth(0); x.setDate(1); return x; }, dateEnd: 'today' },
            //extras:
            {text: 'Vorheriger Monat', dateStart: function(){ return Date.parse('1 month ago').moveToFirstDayOfMonth();  }, dateEnd: function(){ return Date.parse('1 month ago').moveToLastDayOfMonth();  } }
        ...
        presets: {
            specificDate: 'Datum',
            allDatesBefore: 'Alles vor',
            allDatesAfter: 'Alles nach',
            dateRange: 'Zeitraum'
        },
        rangeStartTitle: 'Startdatum',
        rangeEndTitle: 'Enddatum',
        nextLinkText: 'Nächster',
        prevLinkText: 'Vorheriger',
        doneButtonText: 'OK',
